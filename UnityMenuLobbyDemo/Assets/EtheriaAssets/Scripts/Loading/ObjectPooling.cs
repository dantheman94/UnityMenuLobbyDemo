...
public static class NetworkPool : object {
    ...
    private class Pool {
        ...
        public Pool(GameObject obj, int size) {
            ...
            ///ClientScene.RegisterPrefab(_GameObject, ClientSpawn, ClientDespawn);
            RegisterAsset(_AssetID);
        }
        ...
        public GameObject ClientSpawn(Vector3 position, NetworkHash128 assetID) {
            ...
            if (_Parent == null) {
                ...
                _Parent = new GameObject("_OBJECT_POOL: " + _GameObject.name);
                _Parent.transform.position = Vector3.zero;
                _Parent.transform.rotation = Quaternion.identity;
            }
